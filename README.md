...
- [ ] Add support for word-by-word lyrics syncing similar to LRCGET >=v.2.0.0 through their [Lyricsfile](https://github.com/tranxuanthang/lrclib/issues/8#issuecomment-4291600384) extension (YAML format)
